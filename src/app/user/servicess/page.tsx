...
const services: Service[] = [
  ...
  },
  {
    ...
    gradient: 'from-gray-300 via-gray-400 to-white'
  },
  {
    id: 3,
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0">
        ...
        {/* Floating Orbs */}
        <div className="absolute top-20 left-20 w-72 h-72 bg-gradient-to-r from-gray-400/20 to-gray-500/20 rounded-full blur-3xl animate-pulse"></div>
        <div className="absolute bottom-20 right-20 w-96 h-96 bg-gradient-to-r from-gray-300/15 to-gray-500/15 rounded-full blur-3xl animate-pulse" style={{ animationDelay: '2s' }}></div>
        <div className="absolute top-1/2 left-1/3 w-48 h-48 bg-gradient-to-r from-gray-500/10 to-gray-400/10 rounded-full blur-2xl animate-pulse" style={{ animationDelay: '4s' }}></div>
        
        {/* Mouse Follower */}
        <div 
          className="absolute w-64 h-64 bg-gradient-to-r from-gray-400/5 to-gray-500/5 rounded-full blur-3xl pointer-events-none transition-all duration-1000 ease-out"
          style={{
        ...
        {/* Geometric Shapes */}
        <div className="absolute top-32 right-32 w-4 h-4 border border-gray-400/30 rotate-45 animate-spin" style={{ animationDuration: '20s' }}></div>
        <div className="absolute bottom-32 left-32 w-6 h-6 bg-white/20 rotate-12 animate-bounce" style={{ animationDelay: '1s' }}></div>
        <div className="absolute top-2/3 right-1/4 w-3 h-3 bg-gray-500/30 animate-ping" style={{ animationDelay: '3s' }}></div>
      </div>
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className={`text-center mb-20 transition-all duration-1200 ${
          ...
          <div className="inline-block relative">
            <div className="flex items-center justify-center gap-2 mb-4">
              ...
              <Sparkles className="w-5 h-5 text-gray-400 animate-pulse" style={{ animationDelay: '0.5s' }} />
            </div>
            ...
            <h2 className="text-5xl md:text-7xl font-black text-white mb-8 relative tracking-tight">
              ...
              <br />
              <span className="bg-gradient-to-r from-gray-400 via-gray-400 to-gray-500 bg-clip-text text-transparent animate-pulse">
                Services
              </span>
              
              {/* Decorative Elements */}
              <div className="absolute -top-4 -right-4 w-8 h-8 border-2 border-gray-400/50 rotate-45 animate-spin" style={{ animationDuration: '15s' }}></div>
              <div className="absolute -bottom-4 -left-4 w-6 h-6 bg-white/30 animate-bounce" style={{ animationDelay: '1s' }}></div>
            </h2>
          </div>
          
          <p className="text-xl md:text-2xl text-gray-300 max-w-3xl mx-auto leading-relaxed font-light">
            We don&lsquo;t just create designs – we craft 
            <span className="text-gray-400 font-semibold"> digital masterpieces </span>
        ...
        <div className={`text-center transition-all duration-1200 delay-1200 ${
          ...
          <div className="relative inline-block">
            ...
            {/* Glow Effect */}
            <div className="absolute inset-0 bg-gradient-to-r from-gray-400/30 to-gray-500/30 blur-xl opacity-0 group-hover:opacity-100 transition-opacity duration-500 -z-10"></div>
          </div>
        </div>
      </div>
    </section>
...
const ServiceCard: React.FC<ServiceCardProps> = ({ service, index, isVisible }) => {
  ...
  return (
    <div 
      className={`group relative bg-gradient-to-br from-gray-900/50 to-black/50 backdrop-blur-sm border border-gray-800/50 p-8 transition-all duration-700 hover:border-gray-400/50 hover:shadow-2xl hover:shadow-gray-400/10 hover:-translate-y-4 cursor-pointer overflow-hidden ${
    ...
    >
      ...
      <div className="absolute inset-0 rounded-lg opacity-0 group-hover:opacity-100 transition-opacity duration-500">
        <div className="absolute inset-0 rounded-lg bg-gradient-to-r from-gray-400/20 via-transparent to-gray-500/20 blur-sm"></div>
      </div>
      ...
      <div className="relative mb-8 z-10">
        ...
        {/* Floating Particles */}
        <div className={`absolute -top-2 -right-2 w-3 h-3 bg-white rounded-full transition-all duration-500 ${
          isHovered ? 'scale-150 animate-ping' : 'scale-100'
        }`}></div>
        <div className={`absolute -bottom-1 -left-1 w-2 h-2 bg-gray-500 rounded-full transition-all duration-700 ${
      ...
      <div className="absolute top-0 left-0 w-8 h-8 border-l-2 border-t-2 border-gray-400/0 group-hover:border-gray-400/50 transition-all duration-300"></div>
      <div className="absolute bottom-0 right-0 w-8 h-8 border-r-2 border-b-2 border-gray-400/0 group-hover:border-gray-400/50 transition-all duration-300 delay-100"></div>

      {/* Ripple Effect */}
      <div className={`absolute inset-0 rounded-lg transition-all duration-1000 ${
        isHovered 
          ? 'bg-gradient-to-br from-gray-400/5 via-transparent to-gray-500/5' 
          : 'bg-transparent'
      }`}></div>
    </div>
  );
