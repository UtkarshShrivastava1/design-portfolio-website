...
//   return (
//     <div className="h-screen max-h-screen overflow-hidden bg-black text-white">
//       {/* Header */}
...
//       {/* Video Grid */}
//       <div className="px-6 sm:px-12 h-2/3 overflow-y-auto">
//         <div className="max-w-7xl mx-auto h-full">
//           <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 h-full">
//             {videos.map((video, index) => (
//               <div
//                 key={video.id}
//                 className={`group relative overflow-hidden rounded-2xl bg-gray-900 border border-gray-800 hover:border-gray-400/50 transition-all duration-500 hover:shadow-2xl hover:shadow-gray-400/20 ${
//                   video.type === 'portrait' 
//                     ? 'h-full' 
//                     : 'h-full'
//                 }`}
